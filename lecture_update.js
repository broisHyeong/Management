  ...
  switch (menu) {
    ...
    case '강의명':
      ...
      connection.query(updatesql, [lecture_name, lecture_id], (err) => {
        ...
        console.log(`강의번호 ${lecture_id}의 강의명이 ${lecture_name}(으)로 수정되었습니다`);
      });
      break;
    ...
    case '요일':
      ...
      connection.query(updatesql, [lecture_day, lecture_id], (err) => {
        ...
        console.log(`강의번호 ${lecture_id}의 요일이 ${lecture_day}로 수정되었습니다`);
      });
      break;
    ...
    case '시간':
      ...
      connection.query(updatesql, [lecture_time, lecture_id], (err) => {
        ...
        console.log(`강의번호 ${lecture_id}의 시간이 ${lecture_time}(으)로 수정되었습니다`);
      });
      break;
    ...
    case '학점':
      ...
      connection.query(updatesql, [lecture_credit, lecture_id], (err) => {
        ...
        console.log(`강의번호 ${lecture_id}의 학점이 ${lecture_credit}(으)로 수정되었습니다`);
      });
      break;
    ...
    case '전공':
      ...
      connection.query(updatesql, [lecture_type, lecture_id], (err) => {
        ...
        console.log(`강의번호 ${lecture_id}의 전공이 ${lecture_type}(으)로 수정되었습니다`);}
      });
      break;
    default:
